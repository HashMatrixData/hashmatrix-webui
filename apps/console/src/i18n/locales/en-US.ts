...
const consoleEnUS: ConsoleResources = {
  ...
  integration: {
    intro: 'Data source onboarding: register external data sources; connection info is masked (password encrypted, never echoed).',
    tableTitle: 'Data Sources',
    newButton: 'New Data Source',
    drawerTitle: 'New Data Source',
    colName: 'Name',
    colType: 'Type',
    colHost: 'Host',
    colDb: 'Database',
